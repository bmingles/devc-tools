...
```jsonc
"features": { "ghcr.io/bmingles/devc-tools/devc-bridge:1": {} }
```
...
[devc-bridge-client-mount](archived/devc-bridge-client-mount.md) put two bind mounts and
...
`ghcr.io/bmingles/devc-tools/devc-bridge`, using the devcontainers publish
