...
| [`devc/`](devc/README.md) | Selectively bind-mounts sibling projects, Git worktrees, and agent skill folders into the current repo's devcontainer, and mirrors the selection into its `.code-workspace` — editing only its own comment-fenced blocks. |
...
| `devc/` | The project/worktree mount picker — see its [README](devc/README.md) |
